...
1. Git clone ````https://github.com/Dimushok1221/laba1````
...
Запустив приложение вам будет доступна единственная кнопка btn1, нажмите её чтобы передать параметр заданный внутри кнопки. 
